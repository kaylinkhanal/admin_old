...
class StoreOwnerInfo extends Component {
    ...
    render() {console.log(this.state.store_owner_list)
        return (
            <Card>
                <CardHeader>
                    <h5>
                ...
                <CardBody>
                    <Row>
                        <Col xs="6">
                            ...
                            <Row>
                                <Col xs="3">
                                    <Label htmlFor="dishPrice">{this.state.store_owner_list.name}</Label>
                                </Col>
                                <Col xs="3">
                                    <Label htmlFor="dishPrice">{this.state.store_owner_list.email}</Label>
                                </Col>
                                <Col xs="3">
                                    <Label htmlFor="dishPrice">{this.state.store_owner_list.contactNumber}</Label>
                                </Col>
                                <Col xs="3">
